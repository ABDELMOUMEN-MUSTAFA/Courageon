...
<head>
    ...
    <style>
        .hero_single.version_2 {
            background: url('<?= IMAGEROOT ?>/home/banner_home.jpg') center center no-repeat;
        }
        ...
        <main>
                ...
                <div class="container">
                    <ul>
                        <li><i class="fa-solid fa-desktop"></i>
                            <h4><?=  $totalFormations ?> Formations</h4><span>Une large sélection de cours</span>
                        </li>
            ...
            <div class="container-fluid margin_120_0">
                <div class="main_title_2">
                    ...
                    <p>Les formations hautement acclamés et les meilleures ventes de <?= SITENAME ?>.</p>
                </div>
