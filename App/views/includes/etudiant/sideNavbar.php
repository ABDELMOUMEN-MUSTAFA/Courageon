        ...
        <div class="sidebar sidebar-left sidebar-dark bg-dark o-hidden"
            ...
            <div class="sidebar-p-y">
                ...
                <ul class="sidebar-menu sm-active-button-bg">
                    <li class="sidebar-menu-item <?= parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) === "/{$sitename}/etudiant" ? 'active' : '' ?>">
                        <a class="sidebar-menu-button"
                           href="<?= URLROOT ?>/etudiant">
                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">school</i> Mes cours
                        </a>
                    </li>
                    <li class="sidebar-menu-item <?= parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) === "/{$sitename}/etudiant/bookmarks" ? 'active' : '' ?>">
                        <a class="sidebar-menu-button"
                           href="<?= URLROOT ?>/etudiant/bookmarks">
                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">bookmark</i> Mes Bookmarks
                        </a>
                    </li>
                    <li class="sidebar-menu-item <?= parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) === "/{$sitename}/etudiant/messages" ? 'active' : '' ?>">
                        <a class="sidebar-menu-button"
