    ...
    <div id="page" class="theia-exception">
	    ...
	    <footer>
	        <div class="container p-4">
	            <div class="row justify-content-between">
	                ...
	                <div class="col-lg-4 col-md-6">
	                    ...
	                    <ul class="contacts">
	                        ...
	                        <li><a href="mailto:abdelmoumen.mustafa@gmail.com"><i class="fa-solid fa-envelope"></i> abdelmoumen.mustafa@gmail.com</a></li>
	                        <li><a href="mailto:abdelmoumen.mustafa@gmail.com"><i class="fa-solid fa-location-dot"></i> Boulevard de Mohammedia</a></li>
	                    </ul>
	                </div>
	            </div>
	            <!--/row-->
	            ...
	            <div class="row">
	                <div class="col">
	                    <div id="copy">© Copyright <strong><span><?= SITENAME ?></span></strong>. All Rights Reserved</div>
	                </div>
	            </div>
	        </div>
	    </footer>
