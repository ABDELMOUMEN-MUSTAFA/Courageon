...
<body>
	<div class="container bg-dark p-3 rounded">
		...
		<h6 class="text-center text-white">Félicitations pour votre achat de la plateforme <?= SITENAME ?>. Nous espérons que cela
			répondra à
			vos besoins
	...
	<script>
		const animation = bodymovin.loadAnimation({
			...
			loop: false,
			autoplay: true,
			path: '<?= IMAGEROOT ?>/payments/payment-successful.json' // lottie file path
		})
	</script>
</body>
