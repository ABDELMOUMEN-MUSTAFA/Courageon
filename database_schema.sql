...
CREATE DATABASE IF NOT EXISTS `e_learning` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `e_learning`;
...
INSERT INTO `admins` (`id_admin`, `nom`, `prenom`, `email`, `img`, `mot_de_passe`, `balance`) VALUES
	(1, 'ABDELMOUMEN', 'Mustafa', 'e-learning@admin.com', 'users/avatars/default.png', 'admin123@@@', 0);
...
-- Dumping data for table e_learning.apercus: ~0 rows (approximately)
...
-- Dumping data for table e_learning.bookmarks: ~0 rows (approximately)
...
-- Dumping data for table e_learning.categories: ~0 rows (approximately)
...
-- Dumping data for table e_learning.etudiants: ~0 rows (approximately)
...
-- Dumping data for table e_learning.formateurs: ~0 rows (approximately)
...
-- Dumping data for table e_learning.formations: ~0 rows (approximately)
...
-- Dumping data for table e_learning.inscriptions: ~0 rows (approximately)
...
-- Dumping data for table e_learning.jaimes: ~0 rows (approximately)
...
-- Dumping data for table e_learning.langues: ~11 rows (approximately)
...
-- Dumping data for table e_learning.notifications: ~0 rows (approximately)
...
-- Dumping data for table e_learning.videos: ~0 rows (approximately)
